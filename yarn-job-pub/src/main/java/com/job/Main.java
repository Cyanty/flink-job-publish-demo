...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String localUserJar = "C:\\F\\MyProject\\java_project\\flink-pro\\flink-job-publish\\flink-job-example\\target\\flink-job-example-1.0-SNAPSHOT.jar";
        String localUserJarLib = "C:\\F\\MyProject\\java_project\\flink-pro\\flink-job-publish\\flink-job-example\\target\\lib";
        ...
        YarnClientAware yarnClient = YarnClientFactory.getYarnClient(publishType, localUserJar, localUserJarLib,
                hdfsUserJar, hdfsUserJarLib, flinkDistJarPath, applicationName, entryPointClassName);
